...
`tests/fixtures/translation-quality-regressions.json`은 실제 작품·사용자 자막을 포함하지 않는 15개 합성 사례다. 정답 문장 하나를 고정하는 대신, 통과 후보와 의도적 회귀 후보에 대해 보존·금지·상태·가독성 제약이 각각 작동하는지 검사한다.
